...
class AbstractVariableFieldsObject(object):
    ...
    def insert(self, when=None, db=None):
        ...
        from codereview.tracgenericclass.api import GenericClassSystem
    ...
    def list_matching_objects(self, exact_match=True, operator=None):
        """
