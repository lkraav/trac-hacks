...
class PledgieMacro(WikiMacroBase):
    ...
    def expand_macro(self, formatter, name, content):
        ...
        if not content:
            raise TracError("No campaign id given! The campaign id can " \
                            "be found in the pledgie url, e.g. " \
                            "http://pledgie.com/campaigns/ID\n")

        return tag.a(tag.img(src = "http://www.pledgie.com/campaigns/" \
                                   + args[0] + ".png"
