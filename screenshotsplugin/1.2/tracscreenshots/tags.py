...
class ScreenshotsTagProvider(DefaultTagProvider):
    ...
    def check_permission(self, perm, action):
        ...
        perm_map = {
            'create': 'SCREENSHOTS_ADD',
            'modify': 'SCREENSHOTS_EDIT',
        ...
        return super(ScreenshotsTagProvider, self) \
               .check_permission(realm_perm, action) and \
               (perm_map[action] in realm_perm or action == 'modify' and
                perm_map['create'] in realm_perm)
...
class ScreenshotsTags(Component):
    ...
    additional_tags = ListOption('screenshots', 'additional_tags',
        ...
        doc=_("Additional tags that will be created for submitted "
              "screenshots. Possible values are: author, components, "
    ...
    def _get_tags(self, screenshot):
        ...
        if 'description' in self.additional_tags and \
