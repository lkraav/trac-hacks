{   u'headers': [   {'col': 'ticket', 'title': 'ticket'},
                    ...
                    {'col': u'reporter', 'title': u'Reporter'},
                    {'col': u'status', 'title': u'Status'}],
    u'message': Markup(u"""\
<style type="text/css">
.ticket-imported, .modified-ticket-imported { width: 40px; }
.color-new-odd td, .color-new-even td, .modified-ticket-imported, .modified-summary, .modified-owner, .modified-reporter, .modified-status { font-style: italic; }
</style>
<p>
...
<ul><li>Some user names do not exist in the system: me. Make sure that they are valid users.
</li></ul><br/>"""),
