...
setup(
    ...
    long_description = "WikiToPdfPlugin was developed based on the work of coderanger and athomas. WikiToPdf combines the functionality of CombineWikiPlugin and PagetoPdfPlugin on only one plugin and allows one to setup a template file used to generate the PDF file with a cover and a licence page, for example. ",
    license = "GPL",
