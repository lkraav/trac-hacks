...
TracWysiwyg.prototype.listenerToggleEditor = function(type) {
    ...
    case "textarea":
        return function(event) {
            if (self.textarea.style.position == "absolute") {
                self.hideAllMenus();
    ...
    case "wysiwyg":
        return function(event) {
            if (self.frame.style.position == "absolute") {
                try {
        ...
        try {
            if (textarea.style.position == "absolute") {
                ...
                if (self.savedWysiwygHTML !== null && body.innerHTML != self.savedWysiwygHTML) {
                    textarea.value = self.domToWikitext(body, self.options);
                }
            }
        }
        catch (e) {
                    ...
                    if (inCodeBlock) {
                        ...
                        if (!value) {
                            ...
                            if (length > 0) {
                                ...
                                var tmp = lastText + "[[BR]]";
                                var _pattern = wikiInlineRulesPattern;
