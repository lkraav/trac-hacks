...
class Element(object):
    ...
    def layout(self, x, y):
        ...
        self.cardinality_pos = Point(self.x+left_margin, self.y + self.h/2 + 12)
        return (self.w, self.h)

    def plot_cardinality(self):
        cardinality = '[%s..%s]' % (str(self.minoccurs) if self.minoccurs else '?',
...
class CplxType(Element):
    def __init__(self, typename='', minoccurs=None, maxoccurs=None):
        ...
        self.typename = typename if typename else ''
...
class All(Element):
    ...
    def layout(self, x, y):
        ...
        #self.cardinality_pos = Point(self.x, self.y + self.h/2 + 10)
        return (self.w, self.h)
